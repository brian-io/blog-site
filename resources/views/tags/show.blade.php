...
<div class="px-4 sm:px-0">
    <div class="mb-8">
        ...
        @endif
        <p class="text-sm text-gray-500 mt-2">{{ $blogs->total() }} blogs with this tag</p>
    </div>
                ...
                <article class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden">
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-center justify-between text-sm text-gray-500">
                            ...
                            @if($blog->category)
                                <a href="{{ route('categories.show', $blog->category->slug) }}" class="text-blue-600 hover:text-blue-800">
                                    {{ $blog->category->name }}
                                </a>
                            @endif
                        </div>
    ...
    @else
        <div class="text-center py-12">
            <h3 class="text-lg font-medium text-gray-900 mb-2">No blogs with this tag</h3>
            <p class="text-gray-600">Posts will appear here once tagged.</p>
        </div>
    @endif
</div>
@endsection